...
/datum/job/achlys/marine/operative
	...
	spawnpoint_override = "Dante Enlisted"
	latejoin_at_spawnpoints = TRUE
	intro_blurb = "You are an ONI Operative disguised as a marine. Do not allow anyone else to know your true identity. Your job is to kill anyone who sets foot on the UNSC Achlys after the nav computers are destroyed. There must be no survivors and you are considered expendable. You must complete your mission of eliminating all witnesses to the events onboard the Achlys, including any survivors onboard. Execute with extreme prejudice."
