...
/datum/map/first_contact
	...
	allowed_spawns = list("Innie Base Spawns","UNSC Base Spawns","Covenant Base Spawns","Civilian Ship Crew","Civ Ship Cap Crew","Medical Ship Crew","Medical Ship Cap Crew","Emsville Spawn","Emsville Spawn Marshall","Research Facility Spawn","Research Facility Director Spawn","Research Facility Security Spawn","Depot Guard Spawn","UNSC Aegis Ship Crew Spawn","UNSC Aegis ODST Spawn","UNSC Aegis ODST Officer Spawn","Commando Spawn","Commando Officer Spawn")
