...
/datum/game_mode/firefight/stranded
	...
	wave_spawns = list(\
		...
		list(\
			...
			/mob/living/simple_animal/hostile/flood/combat_form/guard = 1,
			/mob/living/simple_animal/hostile/flood/combat_form/oni = 1,
			/mob/living/simple_animal/hostile/flood/combat_form/elite/minor = 1,
			/mob/living/simple_animal/hostile/flood/combat_form/elite/minor2 = 1,
		...
		list(\
			...
			/mob/living/simple_animal/hostile/flood/combat_form/elite/minor = 1,
			/mob/living/simple_animal/hostile/flood/combat_form/elite/minor2 = 1,
			/mob/living/simple_animal/hostile/flood/combat_form/elite/major = 1,
			/mob/living/simple_animal/hostile/flood/combat_form/elite/zealot = 1,
			/mob/living/simple_animal/hostile/flood/combat_form/elite/ultra = 1,
			/mob/living/simple_animal/hostile/flood/combat_form/elite/ranger = 1,
		),
		list(\
			/mob/living/simple_animal/hostile/flood/carrier = 1,
			/mob/living/simple_animal/hostile/flood/combat_form/human = 1,
			...
			/mob/living/simple_animal/hostile/flood/combat_form/elite/zealot = 1,
			/mob/living/simple_animal/hostile/flood/combat_form/elite/ultra = 1,
			/mob/living/simple_animal/hostile/flood/combat_form/elite/specops = 1,
			/mob/living/simple_animal/hostile/flood/combat_form/elite/ranger = 1,
